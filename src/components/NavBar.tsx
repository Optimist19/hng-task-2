...
function NavBar() {
  return (
    <nav className=" px-[4vw] pt-3">
      <header className="bg-[#05252C] flex  items-center justify-between  border border-[#0E464F] py-[2vh] rounded-3xl px-[16px]">
        <div className="cursor-pointer
">
          <img src={logo} alt="company-logo" />
        </div>
        <ul className="font-extralight text-[13px] flex items-center gap-6">
          <li className="text-[#B3B3B3] hover:text-[#FFFFFF] cursor-pointer ">Events</li>

          <li className=" cursor-pointer hover:text-[#FFFfFF] text-[#B3B3B3]">My Tickets</li>
          <li className=" cursor-pointer hover:text-[#FFfFFF] text-[#B3B3B3]">About Project</li>
        </ul>
